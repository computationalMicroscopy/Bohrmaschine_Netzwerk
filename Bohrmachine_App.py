...
def setup_model():
    ...
    # Dynamische CPT für sprunghafte, präzise Änderungen
    cpd_state = TabularCPD(
        variable='State', variable_card=2,
        values=[
            [0.992, 0.776, 0.718, 0.523, 0.375, 0.153, 0.051, 0.001, 0.879, 0.652, 0.591, 0.384, 0.212, 0.084, 0.022, 0.000],
            [0.008, 0.224, 0.282, 0.477, 0.625, 0.847, 0.949, 0.999, 0.121, 0.348, 0.409, 0.616, 0.788, 0.916, 0.978, 1.000]
        ],
...
col3.metric("KI-Bruchrisiko", f"{risk:.1f} %")
